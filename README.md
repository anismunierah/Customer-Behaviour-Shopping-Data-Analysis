...
The SQL queries used to inspect and clean the data for this analysis can be found here: `Python_Data_Cleaning_Script/Customer Shopping Behaviour Analysis Project.ipynb`
