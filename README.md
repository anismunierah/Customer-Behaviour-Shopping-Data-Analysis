...
Targeted SQL queries regarding various business questions can be found here: [SQL EDA Queries Link](https://github.com/anismunierah/Customer-Behaviour-Shopping-Data-Analysis/blob/main/SQL/customer_behaviour_EDA_script.sql)
